package draw.src.main.java.ua.opnu.view;

import draw.src.main.java.ua.opnu.model.DrawShape;
...
public class DrawFrame extends JFrame {
    ...
    private JPanel setButtonPanel() {
        ...
        // 4. Кнопка для очищення поверхні
        BigTextButton clear = new BigTextButton("Clear");
        clear.addActionListener(e -> {
            // Очищаємо всі фігури на поверхні та перемальовуємо
            surface.clearShapes();
        });
        // Додаємо кнопку Clear на верхню панель
